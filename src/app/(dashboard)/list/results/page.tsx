...
function ResultList() {
  const renderRow = (item: Result) => (
    ...
    >
      ...
      <td className="p-2 align-middle">{item.student}</td>
      <td className="hidden md:table-cell p-2 align-middle">{item.score}</td>
      <td className="hidden md:table-cell p-2 align-middle">{item.teacher}</td>
      <td className="hidden md:table-cell p-2 align-middle">{item.class}</td>
