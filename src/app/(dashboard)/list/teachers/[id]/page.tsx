            ...
            <section className="w-full xl:w-1/3">
                <div className="bg-white p-4 rounded-md">
                    ...
                    <div className="mt-4 flex gap-4 flex-wrap text-xs text-gray-50">
                        <Link href="/" className="bg-blueSky text-white rounded-md p-3">Teacher&apos;s Classes</Link>
                        <Link href="/" className="bg-purple text-white rounded-md p-3">Teacher&apos;s Students</Link>
                        <Link href="/" className="bg-yellow text-white rounded-md p-3">Teacher&apos;s Lessons</Link>
                        <Link href="/" className="bg-pink-50 text-white rounded-md p-3">Teacher&apos;s Exams</Link>
                        <Link href="/" className="bg-blueSkyLight text-white rounded-md p-3">Teacher&apos;s Assignments</Link>
                    </div>
                </div>
                <Performance />
                <Announcement />
